...
SELECT SUM(SALDO_DEPOSITO) FROM DEPOSITO WHERE numero_conta = 88294;
SELECT SUM(VALOR_EMPRESTIMO) FROM EMPRESTIMO WHERE numero_conta = 88294;
SELECT * FROM EMPRESTIMO 
WHERE numero_conta = 88294;
SELECT * FROM DEPOSITO 
WHERE numero_conta = 88294;
SELECT SUM(D.SALDO_DEPOSITO)-SUM(E.VALOR_EMPRESTIMO) AS TOTAL
FROM EMPRESTIMO AS E, DEPOSITO AS D
WHERE E.NOME_CLIENTE = D.NOME_CLIENTE
AND   E.NOME_AGENCIA = D.NOME_AGENCIA
AND   E.NUMERO_CONTA = D.NUMERO_CONTA
AND   E.NUMERO_CONTA = 88294
GROUP BY E.NOME_CLIENTE, E.NOME_AGENCIA, E.NUMERO_CONTA;
...
SELECT	C.NOME_CLIENTE, C.CIDADE_CLIENTE,
...
WHERE CONTA.NOME_CLIENTE = RELATORIO.NOME_CLIENTE
AND   CONTA.NOME_AGENCIA = CONTA.NOME_AGENCIA
AND   CONTA.NUMERO_CONTA = RELATORIO.NUMERO_CONTA;
