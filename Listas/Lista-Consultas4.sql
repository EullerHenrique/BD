...
WHERE
cliente.nome_cliente=emprestimo.nome_cliente
AND   
nome_agencia='PUC'
ORDER BY cliente.nome_cliente;
...
from cliente, deposito
where  
cliente.cidade_cliente = 'Contagem'
and 
deposito.saldo_deposito > 3000
and
cliente.nome_cliente = deposito.nome_cliente;
...
SELECT	E.NOME_CLIENTE, E.NOME_AGENCIA, E.NUMERO_CONTA, SUM(D.SALDO_DEPOSITO) as deposito, SUM(E.VALOR_EMPRESTIMO) as emprestimo, 
...
FROM(
	SELECT	E.NOME_CLIENTE, E.NOME_AGENCIA, E.NUMERO_CONTA,
		SUM(D.SALDO_DEPOSITO) as deposito, SUM(E.VALOR_EMPRESTIMO) as emprestimo, 
		SUM(D.SALDO_DEPOSITO)-SUM(E.VALOR_EMPRESTIMO) AS TOTAL
	FROM EMPRESTIMO AS E, DEPOSITO as D
	WHERE E.NOME_CLIENTE = D.NOME_CLIENTE
	AND   E.NOME_AGENCIA = D.NOME_AGENCIA
